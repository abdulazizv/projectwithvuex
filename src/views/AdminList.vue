      ...
      >
        ...
        <div class="overflow-x-auto">
          ...
          >
            ...
            <tbody>
              <tr
                v-for="admin in $store.state.getAdmins.adminList"
                ...
                <td class="px-4 py-3">
                  {{
                    admin.roles.length > 1
                      ? `${admin.roles[0].role_id} ${admin.roles[1].role_id}`
                      : admin.roles[0].role_id
                  }}
                  
                </td>
                <td class="px-4 py-3">{{ admin.posts.length }}</td>
                <td class="px-4 py-3">
                  {{ admin.createdAt.slice(0, 16).split("T").join(" ") }}
                </td>
